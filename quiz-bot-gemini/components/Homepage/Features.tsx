    ...
    <div id="features" className="bg-violet-300 py-40 w-full">
      ...
      <div className="flex flex-col md:flex-row justify-center items-center space-y-4 md:space-y-0 md:space-x-20">
        <div className="flex flex-col items-center justify-center">
          <BiSolidSelectMultiple className="w-10 h-10 mb-9" />
          <h3 className="text-xl font-semibold text-black">Select a topic</h3>
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <h3 className="text-xl font-semibold text-black">Answer Questions</h3>
          <p className="mt-5 text-center">
